...
DB_CONFIG = {
    ...
    'password': os.environ.get('DB_PASSWORD', '1234'), # Şifreni kontrol et
...
def populate_saas_data():
    ...
    try:
        ...
        # 7. KİŞİSEL RUTİNLER
        # ---------------------------------------------------------
        routine_names = ["Bacak Günü", "Sabah Kardiyosu", "Güç Antrenmanı", "Cuma Pompası", "Tatil Programı", "Karın Kası Odaklı"]
